...
urlpatterns = [
    ...
    path("add-new-job/<user_journey_step_efootprint_id>/",model_builder.views_addition.add_new_job, name="add-new-job"),
    ...
    path("get-jobs-type-link-to-service-type/<service_id>/", views.get_jobs_type_link_to_service_type, name="get-service-type")
]
