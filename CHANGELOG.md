...
- Html templates has been updated to have similar structure between all  
  creations/editions objects.
- Simply the html structure of the model-canvas div.

## Fixed
- Fixing the issue where the result chart cannot be displayed when the model 
  is empty. A modal is displayed to inform the user that the model is 
